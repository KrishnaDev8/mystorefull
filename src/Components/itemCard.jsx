...
const ItemCard = ({ product }) => {
  ...
  return (
    // <div className="relative flex w-70 flex-col overflow-hidden rounded-lg border border-gray-100 bg-white shadow-md">
    <div className="justify-around rounded-md border border-gray-200 bg-white shadow-md">
      {/* <div className="relative mx-3 mt-3 flex h-60 overflow-hidden rounded-xl" href="#">
        <img */}
         <div className="grid grid-cols-4 mx-3 mt-3 flex rounded-xl" href="#">
        <img
      ...
      <div className="mt-4 px-5 pb-5">
        ...
        <div className="mt-2 mb-5 flex items-center justify-between">
          ...
          <div className="flex items-center">
            ...
            <span className="mr-2 ml-3 rounded bg-red-600 px-2.5 py-0.5 text-xs text-white font-semibold">
              {stars}.0
            </span>
          </div>
          <p>
